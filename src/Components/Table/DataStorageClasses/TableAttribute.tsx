...
export default class TableAttribute {
    ...
    static getAttributeInputBlock(
        ...
        if (tableAttribute.attributeType === TableAttributeType.TINY) {
            ...
            if (
                tableAttribute.decimalNumDigits === undefined ||
            ...
            for (
                let i = 0;
                i < tableAttribute.decimalNumDigits - tableAttribute.decimalNumDecimalDigits;
                i++
            ) {
                maxValueString += '9'
            }
                ...
                return (
                    ...
                    >
                        ...
                        {tableAttribute.enumOptions?.map((enumOptionString: string) => {
                            return (
                                <option
                                    selected={currentValue === enumOptionString}
                                    key={enumOptionString}
                                    value={enumOptionString}
                                >
                                    {enumOptionString}
                                </option>
                            )
